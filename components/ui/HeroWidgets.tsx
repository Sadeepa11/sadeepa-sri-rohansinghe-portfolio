...
export function SocialDock() {
  const socials = [
    { icon: GithubIcon, href: "https://www.github.com/Sadeepa11", target: "_blank", color: "hover:text-white" },
    { icon: LinkedinIcon, href: "https://www.linkedin.com/in/sadeepa-sri-rohanasinghe-dev", target: "_blank", color: "hover:text-blue-400" },
    { icon: WhatsappIcon, href: "https://wa.me/94765772504", target: "_blank", color: "hover:text-emerald-400" }
  ];
